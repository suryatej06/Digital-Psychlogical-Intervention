    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-gray-500 text-sm">Start using the mental health platform right away</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label htmlFor="alias" className={labelCls}>
                Alias <span className="text-gray-400 font-normal">(optional for anonymous posts)</span>
              </label>
              <input
                id="alias"
                name="alias"
            ...
            <button
              type="submit"
              disabled={loading}
              className={`w-full py-3.5 rounded-2xl font-bold text-base shadow-md transition-all duration-200 ${
                loading
